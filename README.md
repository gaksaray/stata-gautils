...
This is a collection of Stata utility modules that I developed and use across my projects.

## Installation

You can install individual packages or the whole repository from within Stata.
...
Then, you can browse among subdirectories, desribe and download any package:
```stata
net cd r
...
For commands with no help files, type `which [command]`, as I tend to include a short explanation of the command along with its syntax and several examples at the top of `.ado` files.
